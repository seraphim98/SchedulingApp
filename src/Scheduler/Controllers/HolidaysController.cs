...
namespace Scheduler.Controllers
{
    ...
    [ApiController]
    public class HolidaysController(IRepository<Holiday> repository, IMapper mapper) : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<HolidayCreateModel>> PostHoliday(HolidayCreateModel HolidayCreateModel)
        {
